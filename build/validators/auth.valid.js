    ...
    signup: [
        ...
        (0, express_validator_1.body)("email")
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, models_1.StudentModel.exists({ email: email })];
                    case 1:
                        if (_a.sent()) {
                            return [2, Promise.reject("Email already in use!")];
                        }
                        return [2];
                }
            });
        ...
        (0, express_validator_1.body)("email")
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!(_a.sent())) {
                            return [2, Promise.reject("User with this email not exist!")];
                        }
                        return [2];
                }
            });
